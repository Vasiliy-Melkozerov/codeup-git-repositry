(function () {
    ...
    console.log(objectFirst.firstName);
    console.log(objectFirst.lastName);
    ...
    console.log(objectFirst.sayHello());
    ...
    function displayShoppersInfo(shoppers) {
        shoppers.forEach(function (shopper) {
            soncole.log(displayShopperInfo(shopper));
        });
    }
    ...
    //     if (buyer.amount > 200) {
    //         console.log(buyer.name + "has qualified for the discount bringing his total to " + buyer.amount * .88 + " exciting!")
    //     } else {
    //         console.log( "Sorry " + buyer.name + "did not give us enough money to reward you.")
    //     }
    //     console.log(buyer);
